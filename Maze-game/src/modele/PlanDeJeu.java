...
public class PlanDeJeu extends MonObservable implements MonObserver, Runnable {
	...
	private void validerEtatJeu(){
		...
		if(!gestCombat.combatEstEnCours()){
			...
			ListIterator<AbstractEquipement> iterator = this.equipements.listIterator();

			
			while(iterator.hasNext()) {

				AbstractEquipement equipement =  iterator.next();

				if(equipement.estAusol()) {
					if(this.joueur.getCase() == equipement.getCase()) {
						this.joueur.ajoutEquipement(equipement);
						if(equipement instanceof Casque) {
							System.out.println("Tu as trouver un CASQUE de valeur de : " + equipement.getValeur() +"!!!");
						}

						if(equipement instanceof Armure) {
							System.out.println("Tu as trouver un ARMURE de valeur de : " + equipement.getValeur() +"!!!");
						}

						if(equipement instanceof Arme) {
							System.out.println("Tu as trouver un ARME de valeur de : " + equipement.getValeur() +"!!!");
						}

						if(equipement instanceof Potion) {
							System.out.println("Tu as trouver un POTION de valeur de : " + equipement.getValeur() +"!!!");
						}
	...
	private void partiePerdu(){
		...
		System.out.println("On recommance!!!");
		nouveauNiveau();
	}
